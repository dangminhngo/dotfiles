...
_sddm_template.name = "sddm"

_sddm_template.path = "sugar-candy"
...
HeaderText=Today is good day!
## Header can be empty to not display any greeting at all. Keep it short.

TranslatePlaceholderUsername="Who are you?"
TranslatePlaceholderPassword="Passcode"
TranslateShowPassword="Show my password"
TranslateLogin=""
TranslateLoginFailedWarning="Oops. Who are you and what're you trying to do?"
TranslateCapslockWarning="CAPLOCKS is enabled. Who needs it?"
TranslateSession=""
TranslateSuspend=""
TranslateHibernate=""
TranslateReboot=""
